			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
						...
						<div class="pb-20">
							<table class="data-table table stripe hover nowrap">
                                ...
                                <?php $no=1; foreach($tbdata->result() as $n => $val):
									...
									<tr>
										<td><?=$no;?></td>
										<td><?=$val->dep=="newSamatex" ?"Samatex":$val->dep;?></td>
					...
					<div class="card-box mb-30">
						...
						<div class="pd-20">
							<p class="mb-0">
								<strong>Stok milik Samatex di gudang Pusatex</strong>
							</p>
						</div>
						<div class="pb-20">
							<table class="data-table table stripe hover nowrap">
								...
								<tbody>
                                <?php 
								$qr1 = $this->db->query("SELECT * FROM data_stok WHERE dep='stxToPusatex'");
