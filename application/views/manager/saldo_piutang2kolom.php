...
<div class="main-container">
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
                    ...
                    <div class="card-box mb-30">
						...
						<div class="pd-20 card-box mb-30">
                            <div class="clearfix">
                                <table class="table">
                                    <tr>
                                        <td><h2>Total Outstanding</h2></td>
                                        <td><h2 id='thisShowOutstanding'>Loading...</h2></td>
                                    </tr>
                                </table>
                               ...
                               <table class="data-table table stripe hover nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?=base_url('nota/piutangshowall/'.sha1($idcus));?>"><?=$value->nama_konsumen;?></a></td>
                                        ...
                                        if(fmod($total_outstanding, 1) !== 0.00){
                                            $format_totaloutstanding = "Rp. ". number_format($total_outstanding,2,',','.');
                                        } else {
                                            $format_totaloutstanding = "Rp. ". number_format($total_outstanding,0,',','.');
                                        }
                                    }
                                     } ?>
                                    </tbody>
                    ...
                    <?php echo "<input type='hidden' id='iptTotalOutstanding' value='$format_totaloutstanding'>"; ?>
					<!-- Simple Datatable start -->
...
<script>
    var valueouts = document.getElementById('iptTotalOutstanding').value;
    document.getElementById('thisShowOutstanding').innerHTML = ''+valueouts;
</script>